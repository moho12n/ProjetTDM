...
class AjoutMedecinTraitant : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener  {
    ...
    var mContext:Context = this@AjoutMedecinTraitant
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewAdapter = Adapter_AjoutMedecinTraitant(myDataset)
        ...
        call.enqueue(object: Callback<List<Medecin>> {
            ...
            override fun onFailure(call: Call<List<Medecin>>, t: Throwable) {
                Toast.makeText(this@AjoutMedecinTraitant, t!!.message, Toast.LENGTH_SHORT).show()
            }
        })
