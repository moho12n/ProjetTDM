...
import kotlinx.android.synthetic.main.activity_pop_up_signup.*

class PopUpSignup : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pop_up_signup)
    ...
    override fun onBackPressed() {
        ...
        colorAnimation.duration = 10 // milliseconds
        colorAnimation.addUpdateListener { animator ->
